...
Function Download-SEMOSS {
    ...
    if (Test-Connection semoss.org -Count 3 -Quiet) {
			$Link = 'http://semoss.org/download/SEMOSS_v3.3.1_x64.zip'
...
$Act = New-ScheduledTaskAction -Execute "C:\SEMOSS_v3.3.1_x64\startSEMOSS.bat" -WorkingDirectory C:\SEMOSS_v3.3.1_x64
...
start powershell { cd c:\SEMOSS_v3.3.1_x64; 'n'|.\startSEMOSS.bat}
